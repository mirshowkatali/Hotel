...
<body>
<jsp:include page="includes/staff_header.jsp"></jsp:include>
        ...
        <div class="col-md-3 col-lg-2 theme-black side-nav" id="admin_sidebar" role="navigation"
            ...
            <ul class="nav md-pills pills-primary nav-pills nav-stacked" role="tablist">
                ...
                <sec:authorize access="hasRole('MANAGER')">
                    ...
                    <li class="nav-item card-block">
                        <a class="nav-link white-text"  href="/hms/sendMessage" >
                           Send Message</a>
                    </li>
                    <li class="nav-item card-block">
                        <a class="nav-link white-text"  href="/hms/receive" >
                            Receive Message</a>
                    </li>
                    <li class="nav-item card-block">
                        <a class="nav-link white-text" data-toggle="tab" href="#invoice" role="tab">
                            Invoice</a>
                    </li>
                    <li class="nav-item card-block">
                                            ...
                                            <div class="modal hide fade" id="${room.id}p" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form" action="/hms/manage/rooms/edit-${room.id}"
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${completedbookings}" var="booking">
                                            <tr>
                                                ...
                                                <td>${booking.user.username}</td>
                                                 <td class="table-action-mg">
                                                 <a href="<c:url value='/bookings/print-${booking.id}' />"
                                                       class="btn light-blue btn-sm table-actions-buttons">Print</a>
                                                 </td>      
                                            </tr>
                                        </c:forEach>
                                        <div class="modal hide fade" id="${booking.id}c" tabindex="-1" role="dialog"
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${bookings}" var="booking">
                                            <tr>
                                                ...
                                                <td>${booking.status}</td>
                                                <td class="table-action-mg">
                                                 <a href="<c:url value='/manage/bookings/print-${booking.id}' />"
                                                       class="btn light-blue btn-sm table-actions-buttons">Print</a>
                                                 </td> 
                                            </tr>
                                            <div class="modal hide fade" id="${booking.id}" tabindex="-1" role="dialog"
