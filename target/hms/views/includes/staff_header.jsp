...
<header style="margin-bottom: 60px">
    <nav class="navbar navbar-dark theme-black navbar-fixed-top scrolling-navbar"
        ...
        <div class="container-fluid" style="">
            ...
            <sec:authorize access="hasRole('ADMIN')">ADMIN DASHBOARD</sec:authorize>
                        <sec:authorize access="hasRole('MANAGER')">MANAGER DASHBOARD</sec:authorize></span></span></a>
            </div>
            ...
            <div id="navigation">
                <ul class="nav navbar-nav" style="float: right;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link waves-effect waves-light white-text"
                           href="/hms/facilities">SERVICES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link waves-effect waves-light white-text"
