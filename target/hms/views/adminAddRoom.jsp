...
<section id="add_room" style="margin-top: 5%">
    ...
    <form:form action="/hms/admin/new/room" method="post" modelAttribute="room" enctype="multipart/form-data" id="roomForm">
        ...
        <div>
            ...
            <div class="form-group card card-block">
                ...
                <div>
                    ...
                    <form:input type="text"  path="name" id="name" placeholder="Room 412"
                                required="required"/>
                </div>
                <div class="has-error">
                ...
                <div class="change_link" style="text-align: center">
                    <a href="/hms/admin" class="to_register">GO BACK TO ADMIN PANEL</a>
                </div>
            </div>
        </div>
    </form:form>
